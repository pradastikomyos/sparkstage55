...
export function useSessionRefresh() {
    ...
    // Initial session fetch since useAuth (Zustand) doesn't expose the full session object
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        console.log('[SessionRefresh] Initializing for user:', userId);

        // Schedule initial refresh
        scheduleNextRefresh(sessionExpiresAt);
    ...
    }, [userId, sessionExpiresAt, scheduleNextRefresh, heartbeat, clearTimers]);
